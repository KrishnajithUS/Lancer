...
function ListPost({ dataHandler }) {
  ...
  return dataHandler.map((item) => (
    <div className="md:col-span-1 col-span-3  mb-28 ">
      <div className="  h-full   bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div className="m-2">
          <img
